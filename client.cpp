...
int Client::Transmit(int SocketFD) {
    
    
#ifdef DEBUG
    cout << endl << "in Transmit" << endl;
#endif

    
    Controller * controller = new ClientController(SocketFD);
    controller->Transmit();
        
    
#ifdef DEBUG
    cout << endl << "out Transmit" << endl;
#endif
